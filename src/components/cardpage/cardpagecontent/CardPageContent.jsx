              ...
              <tbody>
                <tr>
                  ...
                  <td className="align-middle" style={{ minWidth: "120px" }}>
                    <div className="input-group align-items-center">
                      <div className="input-group-prepend cursor-pointer">
                        <button type="button" className="btn add_minus">
                          <BiDashCircle />
                        </button>
                      </div>
                      ...
                      <div className="input-group-prepend cursor-pointer">
                        <button type="button" className="btn add_plus" >
                          <BiPlusCircle />
                        </button>
                      </div>
                    </div>
                  ...
                  <td className="align-middle">
                    <ins className="h4 m-0 text-main font-weight-bold text-nowrap">
                      64 ₼
                    </ins>
                  </td>
                  <td className="align-middle">
              ...
              <tfoot>
                    ...
                    <div className="row no-gutters mx-n1">
                      <div className="col-6 px-2">
                        ...
                        <div className="input-group rounded-pill border-0 shadow-lg overflow-hidden p-1">
                          <input type="text" className="form-control form-control-sm border-0 rounded-pill"/>
                          <input type="hidden" id="totalforulduzum"/>
                          <div className="input-group-prepend cursor-pointer">
                  ...
                  <td colSpan="4" style={{ border: "0px" }}>
                    <div className="text-right py-3">
                      <h5 className="font-weight-bold">Ümumi məbləğ:
                        <span className="text-special"> 64 ₼</span></h5>
                      <h5 className="font-weight-bold">Endirim:
                        <span className="text-special mb-2"> 0 ₼</span>
                      </h5>
                      <h5 className="font-weight-bold">Yekun məbləğ:
                        <span className="text-special"> 64 ₼</span>
                      </h5>
                    </div>
                  </td>
                </tr>
                <tr>
                  ...
                  <td colSpan="4" className="text-right" style={{ border: "0px" }}>
                    <Link to="/checkout" className="btn bg-main btn-block rounded-pill shadow-lg">Davam et</Link>
                  </td>
                </tr>
              </tfoot>
            </table>

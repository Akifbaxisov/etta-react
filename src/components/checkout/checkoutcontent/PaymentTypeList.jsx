  ...
  return (
    <>
      <div className="payment-wrap rounded-lg bg-white p-3 p-md-4">
        ...
        {/* <!---- Payment Img -----> */}
        <ul className="nav justify-content-center row mx-n1 no-gutters text-center mb-4" id="paymentTypes" role="tablist">
          {/* <!---- Img Cash Payment ----> */}
        ...
        <div className="tab-content" id="paymentTypesContent">
          ...
          <div className="tab-pane fade show" id="type-three" role="tabpanel" aria-labelledby="type-three-tab">
            ...
            <ul className="nav justify-content-center row mx-n1 no-gutters text-center mb-4" id="cardTypes" role="tablist">
              ...
              <div className="tab-pane fade show active" id="card-one" role="tabpanel"
                ...
                <table className="table text-center">
                  ...
                  <tbody>
                    <tr>
                      <th scope="row">
                        <label htmlFor="option-1" className="m-0 cursor-pointer">
                          <input hidden type="radio" defaultValue="1" name="bolkart_hiremonth" id="option-1"/>
                          <BiCheck />
                        </label>
                      </th>
                      <td>1</td>
                    ...
                    <tr>
                      <th scope="row">
                        <label htmlFor="option-2" className="m-0 cursor-pointer">
                          <input hidden type="radio" defaultValue="3" name="bolkart_hiremonth" id="option-2"/>
                          <BiCheck />
                        </label>
                      </th>
                      <td>3</td>
                    ...
                    <tr>
                      <th scope="row">
                        <label htmlFor="option-3" className="m-0 cursor-pointer">
                          <input hidden type="radio" defaultValue="6" id="option-3" name="bolkart_hiremonth" />
                          <BiCheck />
                        </label>
                      </th>
                      <td>6</td>
              ...
              <div className="tab-pane fade" id="card-two" role="tabpanel" aria-labelledby="card-two-tab">
                <table className="table text-center">
                  ...
                  <tbody>
                    <tr>
                      <th scope="row">
                        <label htmlFor="option-5" className="m-0 cursor-pointer">
                          <input hidden type="radio" defaultValue="3" name="hiremonth" id="option-5"/>
                          <BiCheck />
                        </label>
                      </th>
                      <td>3</td>
                    ...
                    <tr>
                      <th scope="row">
                        <label htmlFor="option-6" className="m-0 cursor-pointer">
                          <input hidden type="radio" defaultValue="6" id="option-6" name="hiremonth" />
                          <BiCheck />
                        </label>
                      </th>
                      <td>6</td>
                    ...
                    <tr>
                      <th scope="row">
                        <label htmlFor="option-7" className="m-0 cursor-pointer">
                          <input hidden type="radio" defaultValue="9" id="option-7" name="hiremonth" />
                          <BiCheck />
                        </label>
                      </th>
                      <td>9</td>
              ...
              <div className="tab-pane fade" id="card-three" role="tabpanel" aria-labelledby="card-three-tab">
                <table className="table text-center">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <th scope="row">
                        <label htmlFor="option-9" className="m-0 cursor-pointer">
                          <input hidden type="radio" defaultValue="1" name="albali_hiremonth" id="option-9" />
                          <BiCheck />
                        </label>
                      </th>
                      <td>1</td>
                    ...
                    <tr>
                      <th scope="row">
                        <label htmlFor="option-10" className="m-0 cursor-pointer">
                          <input hidden type="radio" defaultValue="3" name="albali_hiremonth" id="option-10"/>
                          <BiCheck />
                        </label>
                      </th>
                      <td>3</td>
                    ...
                    <tr>
                      <th scope="row">
                        <label htmlFor="option-11" className="m-0 cursor-pointer">
                          <input hidden type="radio" defaultValue="6" id="option-11" name="albali_hiremonth" />
                          <BiCheck />
                        </label>
                      </th>
                      <td>6</td>
          ...
          <div className="tab-pane fade show" id="type-four" role="tabpanel" aria-labelledby="type-four-tab">
            ...
            <div className="row mx-n2">
              <div className="col-12 col-sm-12 px-1 px-sm-2 mb-3 mb-md-6">
                <label htmlFor="actual_address" className="pl-2" style={{fontWeight: "600"}}>Faktiki yaşayış ünvanı</label>
                <input type="text" name="actual_address" className="form-control rounded-pill border-0 shadow-lg" id="actual_address" defaultValue="" />
              </div>
              <div className="col-12 col-sm-12 px-1 px-sm-2 mb-3 mb-md-6">
                <label htmlFor="tel" className="pl-2" style={{fontWeight: "600"}}>Şəhər Nömrəsi</label>
                <input type="text" name="tel" className="form-control rounded-pill border-0 shadow-lg" id="tel" defaultValue="" placeholder="(012) XXX-XX-XX" />
                <span className="m-form__help text-danger"></span>
              </div>
              <div className="col-12 col-sm-6 px-1 px-sm-3 mb-3 mb-md-6">
                <label htmlFor="frend_fullname_1" className="pl-2" style={{fontWeight: "600"}}>Tanış 1 Ad Soyad</label>
                <input type="text" name="frend_fullname_1" className="form-control rounded-pill border-0 shadow-lg" id="frend_fullname_1" defaultValue="" />
                <span className="m-form__help text-danger"></span>
              </div>

              <div className="col-12 col-sm-6 px-1 px-sm-3 mb-3 mb-md-6">
                <label htmlFor="frend_tel_1" className="pl-2" style={{fontWeight: "600"}}>Tanış 1 Əlaqə Nömrəsi</label>
                <div className="row">
                  <div className="col-4 col-sm-4 px-sm-1 mb-3 mb-md-4" style={{paddingRight: "0"}}>
                    <select name="frend_tel_1_code" id="frend_tel_1_code" className="form-control rounded-pill border-0 shadow-lg region">
                      ...
                      <option defaultValue="52">051</option>
                  ...
                  <div className="col-8 col-sm-8 px-sm-1 mb-3 mb-md-4">
                    <input type="text" name="frend_tel_1" className="form-control rounded-pill border-0 shadow-lg" defaultValue="" id="frend_tel_1" placeholder="XXX-XX-XX" />
                    <span className="m-form__help text-danger"></span>
                  </div>
                </div>
              </div>
              <div className="col-12 col-sm-6 px-1 px-sm-3 mb-3 mb-md-6">
                <label htmlFor="frend_fullname_2" className="pl-2" style={{fontWeight: "600"}}>Tanış 2 Ad Soyad</label>
                <input type="text" name="frend_fullname_2" className="form-control rounded-pill border-0 shadow-lg" id="frend_fullname_2" defaultValue="" />
                <span className="m-form__help text-danger"></span>
              </div>
              <div className="col-12 col-sm-6 px-1 px-sm-3 mb-3 mb-md-6">
                <label htmlFor="frend_tel_2" className="pl-2" style={{fontWeight: "600"}}>Tanış 2 Əlaqə Nömrəsi</label>
                <div className="row">
                  <div className="col-4 col-sm-4 px-sm-1 mb-3 mb-md-4" style={{paddingRight: "0"}}>
                  ...
                  <div className="col-8 col-sm-8 px-sm-1 mb-3 mb-md-4">
                    <input type="tel" name="frend_tel_2" className="form-control rounded-pill border-0 shadow-lg" defaultValue="" id="frend_tel_2" placeholder="XXX-XX-XX" />
                    <span className="m-form__help text-danger"></span>
                  </div>
                </div>
              </div>
              <div className="col-12 col-sm-12 px-1 px-sm-3 mb-3 mb-md-12">
                <label htmlFor="sv_image1" className="pl-2" style={{fontWeight: "600"}}>Şəxsiyyət vəsiqəsinin ön üzü (Şəkil tam görünməlidir.)</label>
                <div className="custom-file">
                  <input type="file" className="custom-file-input" id="customFile" name="sv_image1" />
                  <label className="custom-file-label" htmlFor="customFile">Şəkil Seçin (.jpg)</label>
                  <div className="invalid-feedback"></div>
                </div>
              </div>
              <div className="col-12 col-sm-12 px-1 px-sm-3 mb-3 mb-md-12">
                <label htmlFor="sv_image2" className="pl-2" style={{fontWeight: "600"}}>Şəxsiyyət vəsiqəsinin arxa üzü (Şəkil tam görünməlidir.)</label>
                <div className="custom-file">
